      ...
      <div className='flex flex-col py-10 space-y-5'>
        <div className='flex flex-row'>
          <div className='flex flex-col flex-1 space-y-3'>
            <h1 className='text-3xl text-[#ffffff] font-thin'>About Me</h1>
            <p className='text-[#b0b0b0] text-base'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
          ...
          <div className='flex flex-1 flex-col justify-center items-center space-y-4'>
            <h3 className='text-3xl text-[#ffffff]'>My Skills</h3>
            <Skills />
          </div>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <h1 className='flex text-center text-2xl text-[#b0b0b0]'>Clients I've worked with......</h1>
          <Clients />
        </div>
      </div>
    </>
